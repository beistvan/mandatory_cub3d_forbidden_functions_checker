...
allowed_funcs=(
    ...
    mlx_init mlx_new_window mlx_clear_window mlx_pixel_put mlx_new_image mlx_get_data_addr mlx_put_image_to_window mlx_get_color_value mlx_mouse_hook mlx_key_hook mlx_expose_hook mlx_loop_hook mlx_loop mlx_loop_end mlx_string_put mlx_set_font mlx_xpm_to_image mlx_xpm_file_to_image mlx_destroy_window mlx_destroy_image mlx_destroy_display mlx_hook mlx_do_key_autorepeatoff mlx_do_key_autorepeaton mlx_do_sync mlx_mouse_get_pos mlx_mouse_move mlx_mouse_hide mlx_mouse_show mlx_get_screen_size
)
